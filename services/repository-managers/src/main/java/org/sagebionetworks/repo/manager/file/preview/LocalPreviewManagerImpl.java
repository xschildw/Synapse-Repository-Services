 ...
 *
 */
public class LocalPreviewManagerImpl implements  LocalPreviewManager {
	
	static private Log log = LogFactory.getLog(LocalPreviewManagerImpl.class);
	 ...
	 */
	public LocalPreviewManagerImpl(){}
	 ...
	 */
	public LocalPreviewManagerImpl(FileHandleDao fileMetadataDao,
			AmazonS3Client s3Client,
			TempFileProvider tempFileProvider,

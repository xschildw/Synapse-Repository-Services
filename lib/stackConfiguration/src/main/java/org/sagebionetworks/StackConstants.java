...
public class StackConstants {
	...
	public static final String REMOTE_FILEPREVIEW_NOTIFICATION_QUEUE_NAME = "remote-filepreview-notification-queue";
	public static final String REMOTE_FILEPREVIEW_NOTIFICATION_DEAD_LETTER_QUEUE_NAME = REMOTE_FILEPREVIEW_NOTIFICATION_QUEUE_NAME + "-dl";
	public static final String REMOTE_FILEPREVIEW_NOTIFICATION_QUEUE_NAME_TEMPLATE = REMOTE_FILEPREVIEW_NOTIFICATION_QUEUE_NAME + "-%1$s-%2$s";;
	public static final String REMOTE_FILEPREVIEW_NOTIFICATION_DEAD_LETTER_QUEUE_NAME_TEMPLATE = REMOTE_FILEPREVIEW_NOTIFICATION_DEAD_LETTER_QUEUE_NAME + "-%1$s-%2$s";
